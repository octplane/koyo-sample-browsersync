...
(current-locale-specifier 'bestorank)
(load-locales! locales-path)


;; config values ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(current-option-name-prefix "BESTORANK")
...
(define-option db-name #:default "bestorank")
(define-option db-username #:default "bestorank")
(define-option db-password #:default "bestorank")
(define-option db-host #:default "127.0.0.1")
(define-option db-port #:default "5432"
  (string->number db-port))

(define-option test-db-name #:default "bestorank_tests")
(define-option test-db-username #:default "bestorank")
(define-option test-db-password #:default "bestorank")
...
(define-option session-secret-key-path #:default "/tmp/bestorank-secret-key")
...
(define-option product-name "bestorank")
(define-option company-name "bestorank")
(define-option company-address "")
(define-option support-name "Bot Botterson")
(define-option support-email "support@bestorank.com")
